...
namespace System.Collections.Generic
{
    ...
    // internal array.
    //-ArrayList继承IList.List继承IList泛型
    ...
    public class List<T> : IList<T>, System.Collections.IList, IReadOnlyList<T>
    {
        ...
        // given collection.
        //-ICollection比IEnumablator多了一个copyTo的功能，不需要IEnumerable进行遍历操作
        ...
        // Removes the element at the given index. The size of the list is
        // decreased by one.
        //-list内部会维护一个数组，当减法情况下不会重新减少元素，当添加情况下会创建数组
        ...
        //-可以同时接受IComparer<T> 和 Comparison<T>两种形式，Comparision在list内部也是通过创建IComparer<T> 然后传给Array的
